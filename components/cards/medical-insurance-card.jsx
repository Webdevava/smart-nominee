...
const MedicalInsuranceCard = ({ insurance, onEdit, onDelete, isDeleting }) => {
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-popover p-2 rounded-lg">
              ...
              <p className="font-semibold mt-2 truncate">{insurance.policy_type}</p>
            </div>
            <div className="bg-popover p-2 rounded-lg">
              <p className="text-xs text-muted-foreground">Sum Insured</p>
              <p className="font-semibold mt-2 truncate">{insurance.sum_insured}</p>
            </div>
            <div className="bg-popover p-2 rounded-lg">
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete the medical insurance "{insurance.policy_name}"? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
